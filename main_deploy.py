...
class ReactorConfig:
    ...
    totalFuelQty: float
    U3O8Price: float
    EnrichmentPrice: float
    FabricationPrice: float
    ConversionPrice: float
    BatchNumber: float
    BatchCycleLength: float 
    CoreDesignFactor: float

    # Interim Storage
    interimCOST_initial: float
    interimCOST_OM: float
    COSTperHM: float
    HMperASSEMBLY: float
    ASSEMBLYperCORE: float
    yearsForInterimStorage: float
    ...
    # 7. Scaling
    DesignSimplification_safetyPIPING: float
    DesignSimplification_safetyVALVES: float
    DesignSimplification_safetyPUMPS: float
    DesignSimplification_safetyCABLES: float
    DesignSimplification_safetyMECH: float
